...
class gsp_pragati_loginauth_gsp extends GroovyPage {
...
invokeTag('link','g',55,['controller':("downloadCertificate"),'action':("create")],2)
printHtmlPart(6)
})
invokeTag('captureBody','sitemesh',138,['class':(" login")],1)
printHtmlPart(7)
}
...
public static final long LAST_MODIFIED = 1724223396533L
