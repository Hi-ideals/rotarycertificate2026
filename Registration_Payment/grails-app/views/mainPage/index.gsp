...
<script>
	...
	})(window, document, 'script', 'dataLayer', 'GTM-N37K4R8');
</script>
...
<body class="c-layout-header-fixed c-layout-header-mobile-fixed">
	...
	<noscript>
		<iframe src="https://www.googletagmanager.com/ns.html?id=GTM-N37K4R8"
	...
	--%>
			<li><a
				href='http://et.e-trucktax.com/virtualAssistanteTtVa78fc730ef2a35b5086d1b84c9a64AsTnt456214.php'
				onclick='window.open(this.href,"popupwindow", "width=500,height=800,left=800,top=5,scrollbars,toolbar=0,resizable"); return false;'
				Target='_blank'><img src="img/botIcon.png"
					title="Hi <sec:username/>, How can I help you?"
					style="width: 70px;" /></a></li>
			<%--<li>
...
--%>
	...
	<div class="c-layout-page">
		...
		<div class="c-content-box c-size-md"
			style="background-image: url(assets2/base/img/content/backgrounds/bg-100.jpg)">
			<div class="container">
								...
								<div class="panel-body c-panel-body">
									...
									<form method="post" action="register/createUser"
										...
										<g:if test="${flash.emailverify}">
											<div class="message" role="status"
												style="font-size: medium; color: green; font-size: 21px; margin-top: 20px;">
												${flash.emailverify}
											</div>
										</g:if>
										...
										<div class="row">
											...
											<div class="col-md-6">
												<div class="form-group">
													...
													<input type="number" id="phoneno" name="phoneno" min=10
														max=10 class="form-control c-square c-theme input-lg"
	...
	<footer class="c-layout-footer">
						...
						<div class="row">
							...
							<div class="col-md-4 col-sm-6 col-xs-12">
								...
								<div class="c-twitter">
									...
									<P>
										<a href="mailto: support@sequrotechnologies.com">
											support@sequrotechnologies.com</a>
									</P>
		...
		<div class="c-postfooter c-bg-dark-2">
			<div class="container">
				<div class="row">
					<div class="col-md-3">
						<img src="assets2/base/img/layout/logos/log1.png"
							alt="E-trucktax form 2290 filing" style="margin-top: 8px">
					</div>

					<div class="col-md-5" style="margin-top: 13px">
						<p class="" style="color: white">
							Copyright &copy; 2017 by <a href="#" target="_blank"
								style="color: white">www.sequrotechnologies.com All Rights
								Reserved</a>
						</p>
					</div>
